...
import { Alert, Zoom, colors } from "@mui/material";
...
const Result = () => {
  ...
  const[ showpanel , setShowpanel] = useState('result')
  ...
  return (
    ...
    <div className="flex justify-center pt-20">
      ...
      <Accordion expanded={showpanel == 'result'} onClick={() => setShowpanel('result')}>
        <AccordionSummary
          expandIcon={<UnfoldMoreIcon style={{ color: '#4F45E4' }} />}
        ...
        <AccordionDetails>
              ...
              <div className="flex flex-col items-center pb-10">
                ...
                <span className="text-4xl py-7 text-gray-800 dark:text-gray-900">
                  Your Score is{" "}
                  <span className="text-7xl font-bold">{score}</span> out of 5
                  in {getFormatTime(context.timeTaken)} mins
                </span>
      ...
      <div>
        {qnAns.map((i, index) => (
          <div className="w-full flex justify-center" key={index}>
            <Accordion className="w-2/3  border border-gray-300" expanded={showpanel == 'panel'+index} onClick={() => setShowpanel('panel'+index)}>
              <AccordionSummary
                expandIcon={
                  i.answer == i.selected ? (
                  ...
                  {i.options.map((j, index2) => (
                    <li key={index2}>
                      {i.answer === index2 ? (
                        ...
                        <Alert icon={false} style={{ background: "white" }}>
                          {j}
                        </Alert>
                      )}
                    </li>
